...
static const char *fonts[]          = { "LiterationMono Nerd Font:size=10", "Font Awesome 5 Free:size=10", "LiberationMono:size=10" };
static const char dmenufont[]       = "LiberationMono:size=12";
...
static Key keys[] = {
    ...
    { MODKEY,               		XK_q,    spawn,           {.v = qutebrowser}}, // q
    { MODKEY,               		XK_c,    spawn,           {.v = codeblocks}},  // c
    { MODKEY,               		XK_v,    spawn,           {.v = vscode}},      // v
    { MODKEY|ControlMask,   		XK_c,    spawn,           {.v = clion}},       // c 
    { MODKEY|ShiftMask,     		XK_p,    spawn,           {.v = pycharm}},     // p 
    { MODKEY|ShiftMask,     		XK_c,    spawn,           {.v = chrome}},      // c
    { MODKEY,               		XK_w,    spawn,           {.v = zenkit}},      // w
    { MODKEY,               		XK_r,    spawn,           {.v = ranger}},      // r
    { MODKEY|ShiftMask,     		XK_m,    spawn,           {.v = cmus}},        // m 
    { MODKEY|ShiftMask,     		XK_n,    spawn,           {.v = nvim}},        // n
    { MODKEY|ShiftMask|ControlMask, 	XK_c, 	 spawn,      	  {.v = shutDown}},

    { NULL,    	     XF86XK_AudioMute,   	 spawn,           {.v = toggleVolume}},// XF86_TOGGLE
    { NULL,          XF86XK_AudioLowerVolume,    spawn,           {.v = volumeDown}},  // XF86_LOWER
    { NULL,          XF86XK_AudioRaiseVolume,    spawn,           {.v = volumeUp}},    // XF86_RAISE


    { NULL,                 XF86XK_AudioPlay,   spawn,           {.v = playPauseMusic}},// XF86_PAUSE
    { NULL,                 XF86XK_AudioPrev,   spawn,           {.v = previousSong}},  // XF86_PREVIOUS
    { NULL,                 XF86XK_AudioNext,   spawn,           {.v = nextSong}},      // XF86_NEXT


    { NULL,                 XF86XK_MonBrightnessDown,   spawn,           {.v = lowerLight}},     // XF86_LOWER_LIGHT
    { NULL,                 XF86XK_MonBrightnessUp,   	spawn,           {.v = higherLight}},    // XF86_HIGHER_LIGHT
